...
// 	const channel = member.guild.channels.cache.find(ch => ch.name === 'member-joins');
// 	if (!channel) return;

// 	const canvas = Canvas.createCanvas(700, 250);
// 	const ctx = canvas.getContext('2d');

// 	const background = await Canvas.loadImage('https://i.imgur.com/7rqoEcU.png');
...
// 	ctx.font = '28px Coolvetica';
// 	ctx.fillStyle = '#ffffff';
// 	ctx.fillText('Welcome to the server,', canvas.width / 2.5, canvas.height / 2.2);
...
// announce command
        ...
        if(message.member.permissions.has("KICK_MEMBERS")) {
            ...
            .setTitle("Rule 7:")
            .setColor('GREEN')
            .setDescription('If you have a concern or problem please contact <@&741415445365653522> or <@&741415445365653523>.')
            .setFooter('The Mine', 'https://i.imgur.com/Xzq4uyZ.png')
            message.channel.send({embed})
